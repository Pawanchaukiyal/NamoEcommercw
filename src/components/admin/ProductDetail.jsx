...
const ProductDetail = () => {
    ...
    // Delete product -- in firebase -- using id
    const deleteProduct = async (id) => {
        setLoading(true)
        try {
            // call the deldoca and give id to del
            //  firedb--db name, products-collectionname  
            await deleteDoc(doc(fireDB, 'products', id))
            toast.success('Product Deleted successfully')
            // call because to instant update -- show new update after the delete
